...
namespace QLRapChieuPhim.Common
{
    public class Utilities
    {
        ...
        public static T SendDataRequest<T>(string ApiUrl, object input = null)
        {
            ...
            var thanhvien = AppContext.Current.Session.Get<ThanhVienModel.Output.ThongTinThanhVien>("ThanhVien");
            var nhanvien = AppContext.Current.Session.Get<NhanVienModel.Output.ThongTinNhanVien>("NhanVien");
            HttpClient client = new();
            client.BaseAddress = new Uri("https://localhost:44322/");
            client.DefaultRequestHeaders.Accept.Clear();
            if (thanhvien != null)
